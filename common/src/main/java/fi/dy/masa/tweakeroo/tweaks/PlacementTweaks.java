...
//           double x = posIn.getX() + 2 + (facing.getIndex() * 2);
            ...
            @Nullable HitPart hitPart)
    {
        ...
        player.setYaw(yaw);
        PacketUtils.sendPacket(player.networkHandler, new PlayerMoveC2SPacket.LookAndOnGround(yaw, pitch, player.isOnGround()));
        ...
        PacketUtils.sendPacket(player.networkHandler, new PlayerMoveC2SPacket.LookAndOnGround(yawOrig, pitch, player.isOnGround()));
