...
//        }
    ...
    public String getConfigGuiDisplayName()
    {
        ...
        if (!this.modConflict.isEmpty() && Services.PLATFORM.isModLoaded(this.modConflict))
        {
    ...
    public String getComment()
    {
        ...
        if (comment != null && !this.modConflict.isEmpty() && Services.PLATFORM.isModLoaded(this.modConflict))
        {
